...
Module CouplingsForDecays_LRmodelsLRSSM
...
& MdeltaRpp2input,MFdinput,MFd2input,MFeinput,MFe2input,MFuinput,MFu2input,              & 
& MFvinput,MFv2input,Mhhinput,Mhh2input,MHpminput,MHpm2input,MVWLminput,MVWLm2input,     & 
...
& vdinput,vuinput,vRinput,cplcFuFuAhL,cplcFuFuAhR,cplcFuFdcHpmL,cplcFuFdcHpmR,           & 
...
Real(dp),Intent(in) :: MAhinput(3),MAh2input(3),MdeltaRppinput,MdeltaRpp2input,MFdinput(3),MFd2input(3),     & 
...
MAh = MAhinput 
MAh2 = MAh2input 
MdeltaRpp = MdeltaRppinput 
MdeltaRpp2 = MdeltaRpp2input 
MFd = MFdinput 
MFd2 = MFd2input 
MFe = MFeinput 
MFe2 = MFe2input 
...
& RHO1input,ALP1input,LAM1input,ALP3input,ALP2input,LAM4input,LAM2input,LAM3input,       & 
& YDRinput,YL1input,YQ1input,YL2input,YQ2input,mu32input,MU22input,MU12input,            & 
& vdinput,vuinput,vRinput,cplcFeFeAhL,cplcFeFeAhR,cplcFecFedeltaRppL,cplcFecFedeltaRppR, & 
...
& RHO1input,ALP1input,LAM1input,ALP3input,ALP2input,LAM4input,LAM2input,LAM3input,       & 
& YDRinput,YL1input,YQ1input,YL2input,YQ2input,mu32input,MU22input,MU12input,            & 
& vdinput,vuinput,vRinput,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,               & 
...
& RHO1input,ALP1input,LAM1input,ALP3input,ALP2input,LAM4input,LAM2input,LAM3input,       & 
& YDRinput,YL1input,YQ1input,YL2input,YQ2input,mu32input,MU22input,MU12input,            & 
& vdinput,vuinput,vRinput,cplHiggsPP,cplHiggsGG,cplHiggsZZvirt,cplHiggsWWvirt,           & 
...
& RHO1input,ALP1input,LAM1input,ALP3input,ALP2input,LAM4input,LAM2input,LAM3input,       & 
& YDRinput,YL1input,YQ1input,YL2input,YQ2input,mu32input,MU22input,MU12input,            & 
& vdinput,vuinput,vRinput,cplFvFvAhL,cplFvFvAhR,cplFvFeHpmL,cplFvFeHpmR,cplFvFeVWLmL,    & 
...
& RHO1input,ALP1input,LAM1input,ALP3input,ALP2input,LAM4input,LAM2input,LAM3input,       & 
& YDRinput,YL1input,YQ1input,YL2input,YQ2input,mu32input,MU22input,MU12input,            & 
& vdinput,vuinput,vRinput,cplAhhhVZ,cpldeltaRppcdeltaRppVZ,cplcFdFdVZL,cplcFdFdVZR,      & 
...
Complex(dp),Intent(out) :: cplAhhhVZ(3,3),cpldeltaRppcdeltaRppVZ,cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),              & 
...
& RHO1input,ALP1input,LAM1input,ALP3input,ALP2input,LAM4input,LAM2input,LAM3input,       & 
& YDRinput,YL1input,YQ1input,YL2input,YQ2input,mu32input,MU22input,MU12input,            & 
& vdinput,vuinput,vRinput,cplAhhhVZR,cpldeltaRppcdeltaRppVZR,cplcFdFdVZRL,               & 
...
Complex(dp),Intent(out) :: cplAhhhVZR(3,3),cpldeltaRppcdeltaRppVZR,cplcFdFdVZRL(3,3),cplcFdFdVZRR(3,3),          & 
...
& RHO1input,ALP1input,LAM1input,ALP3input,ALP2input,LAM4input,LAM2input,LAM3input,       & 
& YDRinput,YL1input,YQ1input,YL2input,YQ2input,mu32input,MU22input,MU12input,            & 
& vdinput,vuinput,vRinput,cpldeltaRpphhcdeltaRpp,cpldeltaRppcdeltaRppVZ,cpldeltaRppcdeltaRppVZR,& 
...
& RHO1input,ALP1input,LAM1input,ALP3input,ALP2input,LAM4input,LAM2input,LAM3input,       & 
& YDRinput,YL1input,YQ1input,YL2input,YQ2input,mu32input,MU22input,MU12input,            & 
& vdinput,vuinput,vRinput,cplAhHpmcHpm,cplAhcHpmVWLm,cplAhcHpmVWRm,cplcFuFdcHpmL,        & 
...
& RHO1input,ALP1input,LAM1input,ALP3input,ALP2input,LAM4input,LAM2input,LAM3input,       & 
& YDRinput,YL1input,YQ1input,YL2input,YQ2input,mu32input,MU22input,MU12input,            & 
& vdinput,vuinput,vRinput,cplPseudoHiggsPP,cplPseudoHiggsGG,cplAhAhhh,cplcFdFdAhL,       & 
...
& RHO1input,ALP1input,LAM1input,ALP3input,ALP2input,LAM4input,LAM2input,LAM3input,       & 
& YDRinput,YL1input,YQ1input,YL2input,YQ2input,mu32input,MU22input,MU12input,            & 
& vdinput,vuinput,vRinput,cplAhHpmcVWLm,cplAhcVWLmVWRm,cplcFuFdcVWLmL,cplcFuFdcVWLmR,    & 
...
Complex(dp),Intent(out) :: cplAhHpmcVWLm(3,3),cplAhcVWLmVWRm(3),cplcFuFdcVWLmL(3,3),cplcFuFdcVWLmR(3,3),         & 
...
& RHO1input,ALP1input,LAM1input,ALP3input,ALP2input,LAM4input,LAM2input,LAM3input,       & 
& YDRinput,YL1input,YQ1input,YL2input,YQ2input,mu32input,MU22input,MU12input,            & 
& vdinput,vuinput,vRinput,cplAhHpmcVWRm,cplAhcVWRmVWLm,cplcFuFdcVWRmL,cplcFuFdcVWRmR,    & 
...
Complex(dp),Intent(out) :: cplAhHpmcVWRm(3,3),cplAhcVWRmVWLm(3),cplcFuFdcVWRmL(3,3),cplcFuFdcVWRmR(3,3),         & 
...
& vdinput,vuinput,vRinput,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,               & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFdFdVZRL,cplcFdFdVZRR,cplcFdFuHpmL,cplcFdFuHpmR,           & 
& cplcFdFuVWLmL,cplcFdFuVWLmR,cplcFdFuVWRmL,cplcFdFuVWRmR,cplcFecFedeltaRppL,            & 
& cplcFecFedeltaRppR,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,        & 
& cplcFeFeVZR,cplcFeFeVZRL,cplcFeFeVZRR,cplcFeFvcHpmL,cplcFeFvcHpmR,cplcFeFvcVWLmL,      & 
& cplcFeFvcVWLmR,cplcFeFvcVWRmL,cplcFeFvcVWRmR,cplcFuFuAhL,cplcFuFuAhR,cplcFuFuhhL,      & 
& cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplcFuFuVZRL,cplcFuFuVZRR,cplFeFecdeltaRppL,       & 
...
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFeVZRL,cplcFeFeVZRR,             & 
& cplcFeFvcHpmL,cplcFeFvcHpmR,cplcFeFvcVWLmL,cplcFeFvcVWLmR,cplcFeFvcVWRmL,              & 
& cplcFeFvcVWRmR,cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdcVWLmL,cplcFuFdcVWLmR,              & 
& cplcFuFdcVWRmL,cplcFuFdcVWRmR,cplcFuFuAhL,cplcFuFuAhR,cplcFuFuhhL,cplcFuFuhhR,         & 
& cplcFuFuVZL,cplcFuFuVZR,cplcFuFuVZRL,cplcFuFuVZRR,cplFvFvAhL,cplFvFvAhR,               & 
& cplFvFvhhL,cplFvFvhhR,cplFvFvVZL,cplFvFvVZR,cplFvFvVZRL,cplFvFvVZRR,deltaM)
...
& cplcFeFvcVWRmR,cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdcVWLmL,cplcFuFdcVWLmR,              & 
& cplcFuFdcVWRmL,cplcFuFdcVWRmR,cplcFuFuAhL,cplcFuFuAhR,cplcFuFuhhL,cplcFuFuhhR,         & 
& cplcFuFuVZL,cplcFuFuVZR,cplcFuFuVZRL,cplcFuFuVZRR,cplFvFeHpmL,cplFvFeHpmR,             & 
& cplFvFeVWLmL,cplFvFeVWLmR,cplFvFeVWRmL,cplFvFeVWRmR,cplFvFvAhL,cplFvFvAhR,             & 
& cplFvFvhhL,cplFvFvhhR,cplFvFvVZL,cplFvFvVZR,cplFvFvVZRL,cplFvFvVZRR,deltaM)
...
End Module CouplingsForDecays_LRmodelsLRSSM
