...
Module LowEnergy_LRmodelsLRSSM 
Use Control 
...
Subroutine DeltaRho(MAh,MAh2,MdeltaRpp,MdeltaRpp2,MFd,MFd2,MFe,MFe2,MFu,              & 
& MFu2,MFv,MFv2,Mhh,Mhh2,MHpm,MHpm2,MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,             & 
& MVZR2,cplAhAhcVWLmVWLm,cplAhAhVZVZ,cplAhcVWLmVWRm,cplAhhhVZ,cplAhHpmcVWLm,             & 
& cplcdeltaRppcHpmcVWLm,cplcdeltaRppcVWLmcVWLm,cplcdeltaRppcVWLmcVWRm,cplcFdFdVZL,       & 
...
& cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFeFvcVWLmL(3,6),& 
& cplcFeFvcVWLmR(3,6),cplcFuFdcVWLmL(3,3),cplcFuFdcVWLmR(3,3),cplcFuFuVZL(3,3),          & 
...
Call Pi1LoopVZ(0._dp,Mhh,Mhh2,MAh,MAh2,MdeltaRpp,MdeltaRpp2,MFd,MFd2,MFe,             & 
...
End Function C1C2 
End Module LowEnergy_LRmodelsLRSSM 
