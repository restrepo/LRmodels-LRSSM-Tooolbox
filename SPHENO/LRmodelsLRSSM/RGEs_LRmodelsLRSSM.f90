...
! ------------------------------------------------------------------------------  
! File created at 15:11 on 3.10.2016   
! ----------------------------------------------------------------------  
 
 
Module RGEs_LRmodelsLRSSM 
...
Subroutine GToParameters106(g,gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,             & 
& LAM4,LAM2,LAM3,YDR,YL1,YQ1,YL2,YQ2,mu32,MU22,MU12)

Implicit None 
Real(dp), Intent(in) :: g(106) 
Real(dp),Intent(out) :: gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,LAM3,mu32,MU22,MU12
...
Subroutine ParametersToG106(gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,               & 
& LAM4,LAM2,LAM3,YDR,YL1,YQ1,YL2,YQ2,mu32,MU22,MU12,g)
...
& betaLAM32,DLAM3,mu32,betamu321,betamu322,Dmu32,MU22,betaMU221,betaMU222,               & 
& DMU22,MU12,betaMU121,betaMU122,DMU12
...
Call GToParameters106(gy,gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,             & 
& LAM2,LAM3,YDR,YL1,YQ1,YL2,YQ2,mu32,MU22,MU12)
...
Call ParametersToG106(DgBL,Dg2,DgR,Dg3,DRHO2,DRHO1,DALP1,DLAM1,DALP3,DALP2,           & 
& DLAM4,DLAM2,DLAM3,DYDR,DYL1,DYQ1,DYL2,DYQ2,Dmu32,DMU22,DMU12,f)

Iname = Iname - 1 
 
End Subroutine rge106  

Subroutine GToParameters109(g,gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,             & 
& LAM4,LAM2,LAM3,YDR,YL1,YQ1,YL2,YQ2,mu32,MU22,MU12,vd,vu,vR)

Implicit None 
Real(dp), Intent(in) :: g(109) 
Real(dp),Intent(out) :: gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,LAM3,mu32,MU22,MU12,vd,vu,vR
...
Iname = Iname +1 
NameOfUnit(Iname) = 'GToParameters109' 
...
End Subroutine GToParameters109

Subroutine ParametersToG109(gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,               & 
& LAM4,LAM2,LAM3,YDR,YL1,YQ1,YL2,YQ2,mu32,MU22,MU12,vd,vu,vR,g)

Implicit None 
Real(dp), Intent(out) :: g(109) 
Real(dp), Intent(in) :: gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,LAM3,mu32,MU22,MU12,vd,vu,vR
...
Iname = Iname +1 
NameOfUnit(Iname) = 'ParametersToG109' 
...
End Subroutine ParametersToG109

Subroutine rge109(len, T, GY, F) 
Implicit None 
Integer, Intent(in) :: len 
Real(dp), Intent(in) :: T, GY(len) 
Real(dp), Intent(out) :: F(len) 
...
& betaLAM41,betaLAM42,DLAM4,LAM2,betaLAM21,betaLAM22,DLAM2,LAM3,betaLAM31,               & 
& betaLAM32,DLAM3,mu32,betamu321,betamu322,Dmu32,MU22,betaMU221,betaMU222,               & 
& DMU22,MU12,betaMU121,betaMU122,DMU12,vd,betavd1,betavd2,Dvd,vu,betavu1,betavu2,        & 
& Dvu,vR,betavR1,betavR2,DvR
Complex(dp) :: YDR(3,3),betaYDR1(3,3),betaYDR2(3,3),DYDR(3,3),adjYDR(3,3)             & 
& ,YL1(3,3),betaYL11(3,3),betaYL12(3,3),DYL1(3,3),adjYL1(3,3),YQ1(3,3),betaYQ11(3,3)     & 
& ,betaYQ12(3,3),DYQ1(3,3),adjYQ1(3,3),YL2(3,3),betaYL21(3,3),betaYL22(3,3)              & 
& ,DYL2(3,3),adjYL2(3,3),YQ2(3,3),betaYQ21(3,3),betaYQ22(3,3),DYQ2(3,3),adjYQ2(3,3)
Iname = Iname +1 
NameOfUnit(Iname) = 'rge109' 
 
OnlyDiagonal = .Not.GenerationMixing 
q = t 
 
Call GToParameters109(gy,gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,             & 
& LAM2,LAM3,YDR,YL1,YQ1,YL2,YQ2,mu32,MU22,MU12,vd,vu,vR)
...
Call ParametersToG109(DgBL,Dg2,DgR,Dg3,DRHO2,DRHO1,DALP1,DLAM1,DALP3,DALP2,           & 
& DLAM4,DLAM2,DLAM3,DYDR,DYL1,DYQ1,DYL2,DYQ2,Dmu32,DMU22,DMU12,Dvd,Dvu,DvR,f)

Iname = Iname - 1 
 
End Subroutine rge109  

End Module RGEs_LRmodelsLRSSM 
