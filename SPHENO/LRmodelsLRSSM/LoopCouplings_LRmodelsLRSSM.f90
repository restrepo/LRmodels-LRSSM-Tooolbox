...
Module LoopCouplings_LRmodelsLRSSM 
...
Subroutine CoupHiggsToPhoton(mHiggs,inG,ratdeltaRpp,ratFd,ratFe,ratFu,ratHpm,         & 
& ratVWLm,ratVWRm,MdeltaRpp,MFd,MFe,MFu,MHpm,MVWLm,MVWRm,gNLO,coup)

Implicit None 
Complex(dp),Intent(in) :: ratdeltaRpp,ratFd(3),ratFe(3),ratFu(3),ratHpm(3),ratVWLm,ratVWRm

Real(dp),Intent(in) :: MdeltaRpp,MFd(3),MFe(3),MFu(3),MHpm(3),MVWLm,MVWRm
...
Subroutine CoupHiggsToPhotonSM(mHiggs,MdeltaRpp,MFd,MFe,MFu,MHpm,MVWLm,               & 
& MVWRm,gNLO,coup)
...
Subroutine CoupPseudoHiggsToPhoton(mHiggs,inG,ratdeltaRpp,ratFd,ratFe,ratFu,          & 
& ratHpm,ratVWLm,ratVWRm,MdeltaRpp,MFd,MFe,MFu,MHpm,MVWLm,MVWRm,gNLO,coup)
...
Subroutine CoupPseudoHiggsToPhotonSM(mHiggs,MdeltaRpp,MFd,MFe,MFu,MHpm,               & 
& MVWLm,MVWRm,gNLO,coup)
...
End Module LoopCouplings_LRmodelsLRSSM 
