...
Module TreeLevelMasses_LRmodelsLRSSM 
...
Subroutine TreeMasses(MAh,MAh2,MdeltaRpp,MdeltaRpp2,MFd,MFd2,MFe,MFe2,MFu,            & 
...
& MU22,MU12,GenerationMixing,kont)
...
Real(dp),Intent(out) :: MAh(3),MAh2(3),MdeltaRpp,MdeltaRpp2,MFd(3),MFd2(3),MFe(3),MFe2(3),MFu(3),             & 
...
Iname = Iname + 1 
NameOfUnit(Iname) = 'TreeMassesLRmodels/LRSSM'
...
& vd,vu,vR,gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,LAM3,YDR,YL1,            & 
& YQ1,YL2,YQ2,mu32,MU22,MU12,kont)
...
Subroutine TreeMassesEffPot(MAh,MAh2,MdeltaRpp,MdeltaRpp2,MFd,MFd2,MFe,               & 
& MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHpm,MHpm2,MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,              & 
& MVZ2,MVZR,MVZR2,PhiW,UV,TW,UC,ZDR,ZER,UP,ZUR,ZDL,ZEL,ZUL,ZH,ZW,ZZ,vd,vu,               & 
& vR,gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,LAM3,YDR,YL1,YQ1,              & 
& YL2,YQ2,mu32,MU22,MU12,GenerationMixing,kont)
...
& YQ1,YL2,YQ2,mu32,MU22,MU12,GenerationMixing,kont)
...
Subroutine SortGoldstones(MAh,MAh2,MdeltaRpp,MdeltaRpp2,MFd,MFd2,MFe,MFe2,            & 
& MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHpm,MHpm2,MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,              & 
& MVZR,MVZR2,PhiW,UV,TW,UC,ZDR,ZER,UP,ZUR,ZDL,ZEL,ZUL,ZH,ZW,ZZ,kont)
...
End Module TreeLevelMasses_LRmodelsLRSSM 
