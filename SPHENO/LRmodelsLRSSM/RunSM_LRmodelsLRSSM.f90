...
Module RunSM_LRmodelsLRSSM 
 
Use Control 
Use LoopFunctions 
Use Mathematics 
Use StandardModel 
Use RGEs_LRmodelsLRSSM 
...
& LAM2,LAM3,YDR,YL1,YQ1,YL2,YQ2,mu32,MU22,MU12,vd,vu,vR,CKMout,sinW2_out,Alpha_out,      & 
& AlphaS_out,realCKM)
...
Real(dp) :: scale_save, Qin, tz, dt, g1D(109), g62_SM(62) 
 
 
! Run SUSY RGEs from M_SUSY to Qin 
Qin=sqrt(getRenormalizationScale()) 
scale_save = Qin 
Call ParametersToG109(gBLinput,g2input,gRinput,g3input,RHO2input,RHO1input,           & 
& ALP1input,LAM1input,ALP3input,ALP2input,LAM4input,LAM2input,LAM3input,YDRinput,        & 
& YL1input,YQ1input,YL2input,YQ2input,mu32input,MU22input,MU12input,vdinput,             & 
& vuinput,vRinput,g1D)

Call GToParameters109(g1D,gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,            & 
...
End Module RunSM_LRmodelsLRSSM 
