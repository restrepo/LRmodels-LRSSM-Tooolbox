...
Module Model_Data_LRmodelsLRSSM 
...
Complex(dp) :: CG1(2, 3, 2) 
 Real(dp) :: gBL,g2,gR,g3,RHO2,RHO1,ALP1,LAM1,ALP3,ALP2,LAM4,LAM2,LAM3,mu32,MU22,MU12
...
& LAM4GUT,LAM2GUT,LAM3GUT,mu32GUT,MU22GUT,MU12GUT
...
Real(dp) :: gPFu(3,270),gTFu(3),BRFu(3,270),gPFe(3,282),gTFe(3),BRFe(3,282),gPFd(3,270),          & 
...
End Module Model_Data_LRmodelsLRSSM